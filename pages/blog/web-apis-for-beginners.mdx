...
export const meta = {
  ...
  startDate: 'May 19, 2015', // LOL
  date: 'April 19, 2016',
  tags: ['Guides', 'Tools'],
  featured: true,
  description: 'A look at common API principles and information on how to use them.'
}
...
>
> <small><cite><a href="https://twitter.com/SwiftOnSecurity/status/651401028739338240">@SwiftOnSecurity</a></cite></small>
