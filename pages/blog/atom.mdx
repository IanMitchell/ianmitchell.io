...
_**UPDATE:** This post is out of date; I now use Atom full time. Check out my <Link href="/tools"><a>what I use</a></Link> page for more information._
...
![Atom Memory](/static/images/posts/atom_memory.png)
_Atom Memory Usage_

![Sublime Memory](/static/images/posts/sublime_memory.png)
...
![Fuzzy Finder](/static/images/posts/fuzzy_finder.png)
